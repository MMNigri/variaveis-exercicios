...
let comicao = confirm("Recebe comissão? Se sim, aperte em confirme, caso não, clique em cancel")
...
console.log("Recebe comição:", comicao)
console.log("Ano de admição:", adm)
